...
\begin{tikzpicture}
	...
	\draw[smooth,samples=100,domain=0:3,variable=\f,black] plot ({\f*3},{0.5/(sqrt((1-\f^2)^2+(0.1*2*\f)^2))});
	\draw[smooth,samples=100,domain=0:3,variable=\f,blue ] plot ({\f*3},{0.5/(sqrt((1-\f^2)^2+(0.2*2*\f)^2))});
	\draw[smooth,samples=100,domain=0:3,variable=\f,red  ] plot ({\f*3},{0.5/(sqrt((1-\f^2)^2+(0.3*2*\f)^2))});
